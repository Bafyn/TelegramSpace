...
<div class="content-canal-category">
    <div class="wrapper">
        ...
        <!---->
        <!--        <div class="segment-category-canal">-->
        <!--            <a href="#" class="add-canal-cat"></a>-->
        <!--            <div class="title-category">-->
        <!--                <div class="ava-category">-->
        <!--                    <img src="/template/img/elements/ava-category.png" alt="">-->
        <!--                </div>-->
        <!--                <div class="title-text-category">-->
        <!--                    <h4>-->
        ...
        <!--            <div class="desc-category">-->
        <!--                <p>-->
        <!--                    Канал о новостях из мира медиа и информационных-->
        <!--                    технологий и исследованиях социальных сетей.-->
        <!--                </p>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--        <div class="segment-category-canal">-->
